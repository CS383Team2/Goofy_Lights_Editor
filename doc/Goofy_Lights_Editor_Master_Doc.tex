...
\author{CSm383 \\
	...
	Joe Carter - Contributor \\
	Lise Welch - Contributor \\
	Emma Bateman - Contributor
	}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=350pt]{UML/UseCase1.png}}
	\caption{File manipulation}
	\label{fig:UC1}
\end{figure}
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=350pt]{UML/UseCase2.png}}
	\caption{Fill or clear frame with current color}
	\label{fig:UC2}
\end{figure}
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=350pt]{UML/UseCase3.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=350pt]{UML/UseCase4.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=350pt]{UML/UseCase5.png}}
