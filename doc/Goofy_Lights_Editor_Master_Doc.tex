...
\tableofcontents
\newpage % give the table of contents it's own page for future additions
...
\section{Sprint 1 \& 2}
Preliminary Design:  Start: \date{3/06/2017}  End: \date{3/08/2017
Sprint 1 dates:  Start: \date{3/23/2017}  End: \date{4/30/2017}
Sprint 2 dates:  Start: \date{3/30/2017}  End: \date{4/9/2017}
...
\subsubsection{GUI Screenshots}
  ...
  \begin{figure}[H]
  	\centering
  	\fbox{\includegraphics[width=320pt]{GUI_Screenshots/GUI_17-04-17_timeline.png}}
  ...
  \end{figure}
    ...
    \begin{figure}[H]
  	\centering
  	\fbox{\includegraphics[width=320pt]{GUI_Screenshots/GUI_17-04-17_Translate_Frame.png}}
...
%command $ git log --pretty=format:"%h - %an, %cd : %s" --graph --since="2017-04-11" > doc/gitLog_sprint_3.log
...
\subsubsection{GUI Screenshots}
  ...
  \begin{figure}[H]
  	\centering
  	\fbox{\includegraphics[width=320pt]{GUI_Screenshots/GUI_04_Final.jpg}}
...
\subsubsection{UML Diagrams}
    \begin{figure}[H]
    	\centering
    	%\fbox{\includegraphics[width=320pt]{UML2/UseCase2_xxxxxx.png}}
    	\caption{UML }
    	\label{fig:UML2 }
    \end{figure}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=320pt]{UML2/UseCase2_00_Program_Start.png}}
...
\begin{figure}[H]
 	\centering
 	\fbox{\includegraphics[width=320pt]{UML2/UseCase2_01_new_frame.png}}
...
\begin{figure}[H]
   	\centering
   	\fbox{\includegraphics[width=320pt]{UML2/UseCase2_02_Delete_Frame_Final.jpg}}
...
\begin{figure}[H]
   	\centering
   	\fbox{\includegraphics[width=320pt]{UML2/UseCase2_03_Copy_Frame_Final.jpg}}
   	\caption{UML Copy Frame}
   	\label{fig:UML2 }
\end{figure}

\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=320pt]{UML2/UseCase2_04_change_frame_duration.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=320pt]{UML2/UseCase2_05_translate_frame.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=320pt]{UML2/UseCase2_06_Fill-Clear_Frame.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=320pt]{UML2/UseCase2_07_repeat_frame.png}}
	\caption{UML Repeat Frame}
	\label{fig:UML2 }
\end{figure}

\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=320pt]{UML2/UseCase2_08_AddPixel.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=320pt]{UML2/UseCase2_09_Draw_Rectangle.png}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=320pt]{UML2/UseCase2_10_Change_colors.png}}
...
%command $ git log --pretty=format:"%h - %an, %cd : %s" --graph --since="2017-04-20" > doc/gitLog_sprint_4.log
\lstinputlisting[language={}]{gitLog_sprint_4.log}
...
\lstinputlisting{../GoofyLightsEditor/globals.h}

\newpage
\subsection{framestructure.h file}
The FrameData structure used for every frame.
\lstinputlisting{../GoofyLightsEditor/framestructure.h}

\newpage
\subsection{mainwindow.h file}
Defines all the events for the GUI.
\lstinputlisting{../GoofyLightsEditor/mainwindow.h}
...
\newpage
\subsection{FileOperations.h file}
Handles all file related IO.
\lstinputlisting{../GoofyLightsEditor/FileOperations.h}

\newpage
\subsection{gridsquare.h file}
Handles the main grid and events
\lstinputlisting{../GoofyLightsEditor/gridsquare.h}

\newpage
\subsection{gridsquarewrapper.h file}
Wrapper for gridsquare. Contains all the code that works with the main grid.
\lstinputlisting{../GoofyLightsEditor/gridsquarewrapper.h}

\newpage
\subsection{palette.h file}
The palette class for recent colors.
\lstinputlisting{../GoofyLightsEditor/gridsquarewrapper.h}

\newpage
\subsection{player.h file}
The animation player.
\lstinputlisting{../GoofyLightsEditor/player.h}

\newpage
\subsection{helpdialog.h file}
Displays help and documentation dialog.
\lstinputlisting{../GoofyLightsEditor/helpdialog.h}
