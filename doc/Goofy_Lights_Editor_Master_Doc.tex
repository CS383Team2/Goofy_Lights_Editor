...
\title{
	...
	{\Large CS-383}}
\author{
	\makebox[.25\linewidth]{Nick Krenowicz}\\Program Flow Leader\ \and
	\makebox[.25\linewidth]{Paul Martin}\\QT/GUI Leader\ \and
	\makebox[.25\linewidth]{Tim Sonnen}\\File Master\ \and
	\\
	\makebox[.25\linewidth]{Kevin Dorscher}\\Linked List Librarian\ \and
	\\
	\makebox[.25\linewidth]{Joe Carter}\\Developer\ \and
	\\
	\makebox[.25\linewidth]{Lise Welch}\\Developer\ \and
	\\
	\makebox[.25\linewidth]{Emma Bateman}\\Developer\
	\\
	\\}
...
\section{Figures}
  ...
  \begin{figure}[H]
  	\centering
  	\fbox{\includegraphics[width=350pt]{GUI_Screenshots/gui_1.png}}
  ...
  \begin{figure}[H]
  	\centering
  	\fbox{\includegraphics[width=350pt]{GUI_Screenshots/gui_2.png}}
  ...
  \begin{figure}[H]
  	\centering
  	\fbox{\includegraphics[width=350pt]{GUI_Screenshots/gui_2_dialog.png}}
  ...
  \begin{figure}[H]
  	\centering
  	\fbox{\includegraphics[width=350pt]{GUI_Screenshots/gui_3_1.png}}
  ...
  \begin{figure}[H]
  	\centering
  	\fbox{\includegraphics[width=350pt]{GUI_Screenshots/gui_3_2.png}}
  ...
  \begin{figure}[H]
  	\centering
  	\fbox{\includegraphics[width=350pt]{GUI_Screenshots/gui_4.png}}
  ...
  \begin{figure}[H]
  	\centering
  	\fbox{\includegraphics[width=350pt]{GUI_Screenshots/gui_5_1.png}}
  ...
  \begin{figure}[H]
  	\centering
  	\fbox{\includegraphics[width=350pt]{GUI_Screenshots/gui_5_3.png}}
  ...
  \begin{figure}[H]
  	\centering
  	\fbox{\includegraphics[width=350pt]{GUI_Screenshots/gui_5_4.png}}
  ...
  \begin{figure}[H]
  	\centering
  	\fbox{\includegraphics[width=350pt]{GUI_Screenshots/gui_5_2.png}}
